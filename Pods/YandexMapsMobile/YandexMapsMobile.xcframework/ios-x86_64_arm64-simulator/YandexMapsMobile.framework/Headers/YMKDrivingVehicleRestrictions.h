 ...
 * Undocumented
 */
YRT_EXPORT @interface YMKDrivingVehicleRestriction : NSObject
 ...
 * Undocumented
 */
YRT_EXPORT @interface YMKDrivingRoadVehicleRestriction : NSObject
 ...
 * Undocumented
 */
YRT_EXPORT @interface YMKDrivingManoeuvreVehicleRestriction : NSObject
