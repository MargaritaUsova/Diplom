 ...
 */
YRT_EXPORT @interface YMKSearchProperties : NSObject
 ...
 */
YRT_EXPORT @interface YMKSearchPropertiesItem : NSObject
 ...
 */
YRT_EXPORT @interface YMKSearchBusinessObjectMetadata : NSObject
