 ...
 * The image size.
 */
YRT_EXPORT @interface YMKPanoramaImageSize : NSObject
 ...
 */
YRT_EXPORT @interface YMKPanoramaTileLevel : NSObject
 ...
 * Position struct
 */
YRT_EXPORT @interface YMKPanoramaPosition : NSObject
 ...
 * Text marker struct
 */
YRT_EXPORT @interface YMKPanoramaTextMarker : NSObject
 ...
 */
YRT_EXPORT @interface YMKPanoramaCompanyMarker : NSObject
 ...
 * Icon marker struct
 */
YRT_EXPORT @interface YMKPanoramaIconMarker : NSObject
 ...
 * Undocumented
 */
YRT_EXPORT @interface YMKPanoramaIconConnection : NSObject
 ...
 * Undocumented
 */
YRT_EXPORT @interface YMKPanoramaArrowConnection : NSObject
 ...
 */
YRT_EXPORT @interface YMKPanoramaAngularBoundingBox : NSObject
 ...
 * Undocumented
 */
YRT_EXPORT @interface YMKPanoramaPanoramaDescription : NSObject
...
+ (nonnull YMKPanoramaPanoramaDescription *)panoramaDescriptionWithPanoramaId:(nonnull NSString *)panoramaId
