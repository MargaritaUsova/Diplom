 ...
 */
YRT_EXPORT @interface YMKSearchFilterCollection : NSObject
 ...
 */
YRT_EXPORT @interface YMKSearchFilterCollectionNumberRange : NSObject
 ...
 */
YRT_EXPORT @interface YMKSearchFilterCollectionDateRange : NSObject
