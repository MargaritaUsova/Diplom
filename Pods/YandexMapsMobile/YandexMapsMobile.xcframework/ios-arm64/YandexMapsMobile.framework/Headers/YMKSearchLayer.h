 ...
 */
YRT_EXPORT @interface YMKSearchLayer : NSObject
 ...
 *
 * Remark:
 * @param filters has optional type, it may be uninitialized.
 */
- (void)setFilterCollectionWithFilters:(nullable YMKSearchFilterCollection *)filters;

/**
 * @deprecated Use YMKSearchLayer::setFilterCollectionWithFilters:
 * instead.
 */
 ...
 * is a reason to update ALL the icons simultaneously (i.e. icon theme
 ...
 * changing methods (`submitQuery`, `resubmit`, `deselectPlacemark`,
 * etc.) are executed as usual.
 */
