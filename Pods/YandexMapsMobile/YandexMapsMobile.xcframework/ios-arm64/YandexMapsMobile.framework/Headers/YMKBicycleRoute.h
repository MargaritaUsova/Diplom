 ...
 */
YRT_EXPORT @interface YMKBicycleConstructionSegment : NSObject
 ...
 */
YRT_EXPORT @interface YMKBicycleTrafficTypeSegment : NSObject
 ...
 * Bicycle route.
 */
YRT_EXPORT @interface YMKBicycleRoute : NSObject
/**
...
/**
 * @brief Route URI, which can be used with YMKBicycleRouter to fetch
