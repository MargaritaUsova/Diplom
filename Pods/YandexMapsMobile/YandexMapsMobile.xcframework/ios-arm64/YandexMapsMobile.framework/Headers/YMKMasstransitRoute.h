 ...
 * route.
 */
YRT_EXPORT @interface YMKMasstransitWait : NSObject
 ...
 * construction.
 */
YRT_EXPORT @interface YMKMasstransitConstructionSegment : NSObject
 ...
 */
YRT_EXPORT @interface YMKMasstransitTrafficTypeSegment : NSObject
 ...
 */
YRT_EXPORT @interface YMKMasstransitFitness : NSObject
...
/**
 * @brief List of restricted entries with their coordinates along the
 * path.
 */
 ...
 */
YRT_EXPORT @interface YMKMasstransitRouteStopMetadata : NSObject
 ...
 */
YRT_EXPORT @interface YMKMasstransitRouteStop : NSObject
 ...
 */
YRT_EXPORT @interface YMKMasstransitTransferStop : NSObject
 ...
 */
YRT_EXPORT @interface YMKMasstransitTransfer : NSObject
 ...
 */
YRT_EXPORT @interface YMKMasstransitSectionMetadata : NSObject
 ...
 */
YRT_EXPORT @interface YMKMasstransitSectionMetadataSectionData : NSObject
 ...
 * specific route.
 */
YRT_EXPORT @interface YMKMasstransitRouteSettings : NSObject
 ...
 * transit router.
 */
YRT_EXPORT @interface YMKMasstransitRouteMetadata : NSObject
 ...
 */
YRT_EXPORT @interface YMKMasstransitSection : NSObject
 ...
 * router.
 */
YRT_EXPORT @interface YMKMasstransitRoute : NSObject
/**
